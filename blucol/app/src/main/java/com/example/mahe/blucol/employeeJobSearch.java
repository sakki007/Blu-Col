...
public class employeeJobSearch extends AppCompatActivity implements GestureDetector.OnGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView5 = (TextView) findViewById(R.id.textView31);




        Intent intent9 = getIntent();
        ArrayList<String> mUsernames  = intent9.getStringArrayListExtra("useful");
